...
public class Seminario {
	...
	@OneToMany(mappedBy = "seminario")						//mappedBy vai mapear no atributo chamado seminario
	Set<InscricaoSeminario> inscricoes = new HashSet<>(); 	// nao vai ter objeto repitido
	...
	/**
	 * @param inscricoes the inscricoes to set
	 */
